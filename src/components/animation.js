...
class Animation {
  ...
  loadingToMainPage = () => {
    gsap.to(dom.get('.loading'), { duration: 0, opacity: 0, display: "none" })
    gsap.to(dom.get('.toggle'), { duration: 0, opacity: 0, display: "none" })
    gsap.to(dom.get('.calculator'), { duration: 0, opacity: 0, display: "none" })
    gsap.to(dom.get('.toggle'), { duration: 1, opacity: 1, display: "grid" })
    gsap.to(dom.get('.calculator'), { duration: 1, opacity: 1, display: "grid" })
  }
}
